/**
 * BLOGGER AKORDEON SİTE HARİTASI (ETİKET DUYARLI)
 * ---------------------------------------------------
 * by Blogger Grupları
 * URL: http://cizgifilmhikayeleri.blogspot.com.tr/
 * Modified by Blogger Eklentileri
 * URL: http://bloggereklentileri.blogspot.com.tr/p/arsiv-blogger-eklentileri.html
 * ---------------------------------------------------
 */
...
var toc_config = {
	...
	showNew: 15,
	newText: ' <strong style="font-weight:normal;font-style:normal;color:#fff;font-size:11px;background:#5b587d;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;">Yeni</strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
